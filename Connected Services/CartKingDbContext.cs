...
namespace Cart_King.Connected_Services
{
    public class CartKingDbContext : DbContext
    {
        ...
        // Pulls sales data to homepage
        public DbSet<SalesDeal> SalesDeals { get; set; } = null!;
     ...
     protected override void OnModelCreating  (ModelBuilder modelBuilder)
        {
            ...
            new Product {ProductId = 4, Name = "MSI MPG Infinite Z3 AI Gaming PC - AMD Ryzen 9, RTX 5080, 2 TB SSD", Price = 2699.99M, ImageUrl = "https://media.currys.biz/i/currysprod/10282274?$l-large$&fmt=auto", StockQuantity = 10, CategoryId = 4, ShortDescription = "This MSI Infinite Z3 packs a punch with its AMD Ryzen 9 Processor. That means it's great for top-tier gaming." },   
            ...
            new Product {ProductId = 6, Name = "NINTENDO Switch 2", Price = 395.00M, ImageUrl = "https://media.currys.biz/i/currysprod/10281815?$l-large$&fmt=auto", StockQuantity = 100, CategoryId = 6, ShortDescription = "Game anywhere with Nintendo Switch 2. Inside, it's got beefed up processing and graphics, which means it's ready to take on massive games" } 
